...
import { c as configureSvgSize } from "./chunk-DU6HZSFF-bcKLY1bs.js";
import { t as selectSvgElement } from "./chunk-CLGD4ZFX-BBushEF7.js";
import { n as parse } from "./mermaid-parser.core-BKovPI_5.js";
//#region node_modules/mermaid/dist/chunks/mermaid.core/infoDiagram-FKFFQAWI.mjs
var parser = { parse: /* @__PURE__ */ __name(async (input) => {
	const ast = await parse("info", input);
	log.debug(ast);
}, "parse") };
var DEFAULT_INFO_DB = { version: "11.17.1" };
var diagram = {
	parser,
